...
-define(FILEPATH, "src\\gossip_actor.gleam").
...
-file("src\\gossip_actor.gleam", 90).
-spec forward_rumor_to_random_neighbor(gossip_state(), binary()) -> nil.
forward_rumor_to_random_neighbor(State, Content) ->
...
-file("src\\gossip_actor.gleam", 46).
...
-file("src\\gossip_actor.gleam", 26).
...
-file("src\\gossip_actor.gleam", 115).
