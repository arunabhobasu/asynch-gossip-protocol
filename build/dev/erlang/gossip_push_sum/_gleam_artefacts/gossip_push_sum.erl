...
-file("src\\gossip_push_sum.gleam", 62).
...
-file("src\\gossip_push_sum.gleam", 110).
...
-file("src\\gossip_push_sum.gleam", 75).
-spec run_simulation(
    integer(),
    gossip_algorithms@topology:topology_type(),
    algorithm_type()
...
-file("src\\gossip_push_sum.gleam", 16).
-spec main() -> nil.
main() ->
    Args = get_args(),
    case Args of
